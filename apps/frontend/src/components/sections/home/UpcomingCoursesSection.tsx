...
function formatDateShort(dateString: string | Date): string {
  ...
  return `${day < 10 ? '0' + day : day} Thang ${month}`;
}
    ...
    <section className="bg-white py-20 md:py-28 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn direction="up" className="mb-10">
          <p className="text-sky-500 text-xs font-bold uppercase tracking-widest mb-2">Sap khai giang</p>
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-2">
            Khoa Hoc Sap Khai Giang
          </h2>
          <p className="text-gray-500 text-sm leading-relaxed max-w-xl">
            Dam bao cho cua ban trong cac hoc phan chuyen sau do chuyen gia huong dan sap toi cua chung toi.
          </p>
        </FadeIn>
        ...
        {courses.length > 0 ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between items-center pt-5 mt-5 border-t border-gray-100">
                    <div>
                      <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Bat dau sau</p>
                      <p className="text-sky-500 font-bold text-lg leading-tight">{daysUntil} Ngay</p>
                    </div>
                    <Link href={`/courses/${course.slug}`}>
          ...
          <FadeIn>
            <div className="text-center py-16 bg-gray-50 rounded-2xl border border-gray-200">
              ...
              <p className="text-gray-400">Chua co khoa hoc sap khai giang. Hay theo doi de cap nhat som nhat!</p>
            </div>
          </FadeIn>
        )}
      </div>
